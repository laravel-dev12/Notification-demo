        ...
        return (
            t.extend(c.prototype, {
                ...
                update: function (i) {
                    ...
                    return (
                        ...
                        this.options.cornerclass !== s.cornerclass &&
                            this.container
                                .removeClass("ui-corner-all " + s.cornerclass)
                                .addClass(this.options.cornerclass),
                        ...
                        !1 === this.options.addclass
                            ...
                            : this.options.addclass !== s.addclass &&
                              this.elem
                                  .removeClass(s.addclass)
                                  .addClass(this.options.addclass),
                        !1 === this.options.title
                            ? this.title_container.slideUp("fast")
                            : this.options.title !== s.title &&
                              (this.options.title_escape
                                  ? this.title_container.text(
                                        this.options.title
                                    )
                                  : this.title_container.html(
                                        this.options.title
                                    ),
                              !1 === s.title &&
                        ...
                        (this.options.icon !== s.icon ||
                            (!0 === this.options.icon &&
                                this.options.type !== s.type)) &&
                            (this.container
                                .find("div.ui-pnotify-icon")
                                .remove(),
                            !1 !== this.options.icon &&
                                t("<div />", { class: "ui-pnotify-icon" })
                                    .append(
                ...
                remove: function (s) {
                    ...
                    return (
                        this.timer &&
                            (i.clearTimeout(this.timer), (this.timer = null)),
                ...
                parseOptions: function (i, s) {
                    (this.options = t.extend(!0, {}, c.prototype.options)),
                        (this.options.stack = c.prototype.options.stack);
                    for (
                        var e, o = [i, s], n = 0;
                        n < o.length && void 0 !== (e = o[n]);
                        n++
                    )
                ...
                animateOut: function (i) {
                    ...
                    var s = this,
                        e = function () {
                            if (
                                (s.animTimer && clearTimeout(s.animTimer),
                                "out" === s.animating)
                            )
                                if (
                                    "0" != s.elem.css("opacity") &&
                                    s.elem.is(":visible")
                                )
                                    s.animTimer = setTimeout(e, 40);
                                else {
                                    if (
                                        (s.elem.removeClass("ui-pnotify-in"),
                                        s.options.stack.overlay)
                                    ) {
                                        var o = !1;
                    ...
                    if ((void 0 === i.context && (i.context = o), i)) {
                        ...
                        if (!e || t) {
                            ...
                            switch (
                                ...
                                case "down":
                                case "up":
                                    s.outerHeight(!0) > i.addpos2 &&
                                        (i.addpos2 = s.height());
                                    break;
                                case "left":
                                case "right":
                                    s.outerWidth(!0) > i.addpos2 &&
                                        (i.addpos2 = s.width());
                            }
                            switch (
                                ("number" == typeof i.nextpos1 &&
    ...
    return (
        ...
        (i.prototype.modules.animate = {
            ...
            setUpAnimations: function (n, i) {
                if (i.animate) {
                    ...
                    "slow" === n.options.animate_speed
                        ...
                        ? (t = 200)
                        : n.options.animate_speed > 0 &&
                          (t = n.options.animate_speed),
                        (t /= 1e3),
                        n.elem
                            .addClass("animated")
                            .css({
            ...
            animateIn: function (n) {
                ...
                var i = this;
                (n = function () {
                    i.notice.elem.removeClass(i.options.in_class),
                        this && this.call(),
            ...
            animateOut: function (n) {
                ...
                var i = this;
                (n = function () {
                    i.notice.elem.removeClass(
                        "ui-pnotify-in " + i.options.out_class
                    ),
                        this && this.call(),
                        (i.notice.animating = !1);
                }.bind(n)),
            ...
            init: function (s, i) {
                ...
                s.elem.on({
                    mouseenter: function (o) {
                        !n.options.sticker ||
                            (s.options.nonblock &&
                                s.options.nonblock.nonblock &&
                                !n.options.show_on_nonblock) ||
                            n.sticker
                    ...
                    mouseleave: function (o) {
                        n.options.sticker_hover &&
                            n.sticker.css("visibility", "hidden"),
                            n.options.closer_hover &&
                                n.closer.css("visibility", "hidden");
                    },
                }),
                    (this.sticker = o("<div />", {
                        ...
                        .bind("pnotify:buttons:toggleStick", function () {
                            var i =
                                    null === n.options.classes.pin_up
                                        ? s.styles.pin_up
                                        : n.options.classes.pin_up,
                                e =
                                    null === n.options.classes.pin_down
                                        ? s.styles.pin_down
                                        : n.options.classes.pin_down;
                            o(this)
                                .attr(
                                    "title",
                                    s.options.hide
                                        ? n.options.labels.stick
                                        : n.options.labels.unstick
                                )
                                .children()
                                .attr("class", "")
    ...
    return (
        ...
        (t.prototype.remove = function (o) {
            ...
            this.options.before_close &&
                (t = this.options.before_close(this, o)),
                !1 !== t &&
                    (n.apply(this, arguments),
                    this.options.after_close &&
                        this.options.after_close(this, o));
        }),
        t
    );
});
...
!(function (t, n) {
    ...
    return (
        ...
        (n.prototype.modules.confirm = {
            ...
            update: function (t, n) {
                n.confirm
                    ? (this.makeDialog(t, n), this.container.show())
            ...
            makeDialog: function (o, e) {
                ...
                this.container.empty(),
                    e.prompt &&
                        (this.prompt = t(
                            ...
                            .addClass(
                                (void 0 === o.styles.input
                                    ? ""
                                    : o.styles.input) +
                                    " " +
                                    (void 0 === e.prompt_class
                                        ? ""
                                        : e.prompt_class)
                            )
                ...
                for (
                    var u =
                            e.buttons[0] &&
                            e.buttons[0] !==
                                n.prototype.options.confirm.buttons[0],
                        c = 0;
                    c < e.buttons.length;
                    c++
                )
                    null === e.buttons[c] ||
                        ...
                        (s = t(
                            ...
                            .addClass(
                                (void 0 === o.styles.btn ? "" : o.styles.btn) +
                                    " " +
                                    (void 0 === i.addClass ? "" : i.addClass)
                            )
                            .text(i.text)
                            .appendTo(this.container)
                            .on(
        ...
        t.extend(n.styling.bootstrap3, {
            btn: "btn btn-default",
            input: "form-control",
        }),
        t.extend(n.styling.fontawesome, {
            btn: "btn btn-default",
            input: "form-control",
        }),
        n
...
!(function (i, t) {
                ...
                "Notification" in window
                    ...
                    ? function (i, t) {
                          return navigator.mozNotification
                              .createNotification(i, t.body, t.icon)
                              .show();
                      }
    ...
    return (
        ...
        (t.prototype.modules.desktop = {
            genNotice: function (i, t) {
                null === t.icon
                    ...
                    (null !== this.tag && null === t.tag) ||
                        (this.tag =
                            null === t.tag
                                ? "PNotify-" + Math.round(1e6 * Math.random())
                                : t.tag),
            ...
            init: function (i, n) {
                if (n.desktop) {
                    if (0 !== (o = t.desktop.checkPermission()))
                        return void (
                            n.fallback || (i.options.auto_display = !1)
                        );
                    this.genNotice(i, n);
                }
            },
            ...
            afterOpen: function (i, t) {
                (0 !== o && t.fallback) ||
                    ...
                    (i.elem
                        .css({ left: "-10000px" })
                        .removeClass("ui-pnotify-in"),
                    "show" in i.desktop && i.desktop.show());
            },
            ...
            afterClose: function (i, t) {
                (0 !== o && t.fallback) ||
                    ...
                    (i.elem
                        .css({ left: "-10000px" })
                        .removeClass("ui-pnotify-in"),
                    "close" in i.desktop && i.desktop.close());
            },
        }),
        (t.desktop = {
            permission: function () {
    ...
    return (
        ...
        (i.prototype.modules.history = {
            init: function (i, n) {
                if (
                    ((i.options.destroy = !1),
                    (this.inHistory = n.history),
                    n.menu && void 0 === e)
                ) {
                    e = t("<div />", {
                        class:
                            "ui-pnotify-history-container " + i.styles.hi_menu,
                        mouseleave: function () {
                            e.css("top", "-" + o + "px");
                        },
                    })
                        ...
                        .append(
                            t("<button />", {
                                class:
                                    "ui-pnotify-history-all " + i.styles.hi_btn,
                                text: n.labels.all,
                                mouseenter: function () {
                                ...
                                click: function () {
                                    return (
                                        t(this).trigger("pnotify.history-all"),
                                        !1
                                    );
                                },
                            })
                        ...
                        .append(
                            t("<button />", {
                                ...
                                click: function () {
                                    return (
                                        t(this).trigger("pnotify.history-last"),
                                        !1
                                    );
                                },
                            })
            ...
            update: function (t, i) {
                (this.inHistory = i.history),
                    i.fixed && e
                        ? e.addClass("ui-pnotify-history-fixed")
                        : e && e.removeClass("ui-pnotify-history-fixed");
            },
                ...
                if (i.notices && i.notices.length > o.maxonscreen) {
                    ...
                    (n =
                        "top" !== e.options.stack.push
                            ? i.notices.slice(
                                  0,
                                  i.notices.length - o.maxonscreen
                              )
                ...
                (this.swipe_dismiss = o.swipe_dismiss),
                    ...
                    i.elem.on({
                        touchstart: function (o) {
                            t.swipe_dismiss &&
                                ((e = o.originalEvent.touches[0].screenX),
                                (s = i.elem.width()),
                                i.container.css("left", "0"));
                        },
                        touchmove: function (o) {
                            if (e && t.swipe_dismiss) {
                                ...
                                n = a - e;
                                var c =
                                    (1 - Math.abs(n) / s) * i.options.opacity;
                                i.elem.css("opacity", c),
                                    i.container.css("left", n);
                            }
                        },
                        touchend: function () {
                            if (e && t.swipe_dismiss) {
                                if (Math.abs(n) > 40) {
                                    var o = n < 0 ? -2 * s : 2 * s;
                                    i.elem.animate({ opacity: 0 }, 100),
                                        i.container.animate({ left: o }, 100),
                                        i.remove();
                                } else
                                    i.elem.animate(
                    ...
                    ? (o.elem.addClass("ui-pnotify-mobile-able"),
                      i(window).width() <= 480
                          ? (o.options.stack.mobileOrigSpacing1 ||
                                ((o.options.stack.mobileOrigSpacing1 =
                                    o.options.stack.spacing1),
                                (o.options.stack.mobileOrigSpacing2 =
                                    o.options.stack.spacing2)),
            ...
            if (
                ...
                if (
                    ...
                    e.match(
                        ...
                        : e.match(
                              /^(focus|blur|select|change|reset)$|^key(press|down|up)$/
                          )
                        ...
                        : e.match(/^(scroll|resize|(un)?load|abort|error)$/) &&
                          ...
                          t.initEvent(e, n.bubbles, n.cancelable)),
                    !t)
                )
                    return;
                ...
                e.match(/^on/) || (e = "on" + e),
                    (t = document.createEventObject(n)),
                    this.fireEvent(e, t);
        },
        i = function (e, i, c) {
            ...
            "auto" === a && "A" === l.tagName && (a = "pointer"),
                ...
                (n && n.get(0) == l) ||
                    (n &&
                        (t.call(n.get(0), "mouseleave", i.originalEvent),
                        t.call(n.get(0), "mouseout", i.originalEvent)),
                ...
                o.elem.on({
                    mouseenter: function (e) {
                        t.options.nonblock && e.stopPropagation(),
                            t.options.nonblock &&
                                o.elem.addClass("ui-pnotify-nonblock-fade");
                    },
                    mouseleave: function (e) {
                        t.options.nonblock && e.stopPropagation(),
                            ...
                            t.options.nonblock &&
                                "out" !== o.animating &&
                                o.elem.removeClass("ui-pnotify-nonblock-fade");
                    },
                    ...
                    mousemove: function (e) {
                        t.options.nonblock &&
                            (e.stopPropagation(), i(o, e, "onmousemove"));
                    },
                    ...
                    click: function (e) {
                        t.options.nonblock &&
                            (e.stopPropagation(), i(o, e, "onclick"));
                    },
                    dblclick: function (e) {
                        t.options.nonblock &&
                            (e.stopPropagation(), i(o, e, "ondblclick"));
                    },
                });
            },
        }),
